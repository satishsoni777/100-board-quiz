...
import 'package:gamedemo/home_page.dart';
import 'package:gamedemo/redux/model.dart';
import 'package:redux/redux.dart';
import 'package:gamedemo/redux/reducer.dart';
import 'package:gamedemo/redux/middle_ware.dart';
...
class MyApp extends StatelessWidget {
  final Store<AppState> store = Store<AppState>(reducer,
      initialState: AppState().initialData(),
      middleware: [
        middleWare,
      ]);
  @override
